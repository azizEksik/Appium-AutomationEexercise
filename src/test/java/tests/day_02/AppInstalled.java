...
public class AppInstalled {
    ...
    public void uploadApp() throws MalformedURLException {
        ...
        capabilities.setCapability(MobileCapabilityType.APP, "C:\\Users\\90545\\IdeaProjects\\com.Appium\\Apps\\arabam.com_4.8.0_Apkpure.apk"); // cihazda calistirmak istedigimiz app'in path'ini belirttigimiz method, ciahaza bu uygulamı yükleriz
