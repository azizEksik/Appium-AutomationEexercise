    ...
    public static AndroidDriver getAndroidDriver()  {
        ...
        if (appiumDriver == null) {
            ...
            caps.setCapability(MobileCapabilityType.NO_RESET,false);  // true uygulama sifirlanmiyor onceki adimlari muhafaza ediyor
                                                                            // false ise her test baslangicinda önbellegi sifirliyor
                                                                            // Bunu kullanmamızın sebebi bilgilerimiz kaydedildikten sonra uygulama en baştan başlayamamız(uygulama bizden artık kullanıcı adı ve sifre istemiyor)
                                                                            // Bu sebeple en baştan başlaya bilmek için önbellegi temizlemek icin kullanırız
